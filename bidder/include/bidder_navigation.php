<nav id="sidebarMenu" class="sidebar d-md-block bg-primary text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item <?php if (strpos($_SERVER['PHP_SELF'], "/bid.php")) { ?>  active <?php   }  ?>">
                <a href="./bid.php" class="nav-link">
                    <span class="sidebar-icon"><span class="fas fa-gavel"></span></span>
                    <span>Manage Bid</span>
                </a>
            </li>
            <li class="nav-item <?php if (strpos($_SERVER['PHP_SELF'], "/winner_bid.php")) { ?>  active <?php   }  ?>">
                <a href="./winner_bid.php" class="nav-link">
