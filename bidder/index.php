                    ...
                    <div class="col-xl-4 col-sm-6 mb-3">
                        ...
                        <div class="card border-light shadow-sm">
                            ...
                            <div
                                ...
                                <a class="small stretched-link text-decoration-none my-1" href="./bid.php">View
                                    Bids</a>
                    ...
                    <div class="col-xl-4 col-sm-6 mb-3">
                        ...
                        <div class="card border-light shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="col">
                                        <h2 class="h5">Total Win Bid</h2>
                                        <h3 class="mb-1">
                                            <?php

                                            $query = "SELECT * FROM products WHERE winner = ?";
                            ...
                            <div
                                class="card-footer d-flex align-items-center justify-content-between bg-gradient-white py-2">
                                <a class="small stretched-link text-decoration-none my-1" href="./winner_bid.php">View
                                    Win Bid</a>
                                <div class="small my-1">
                                    <i class="fas fa-angle-right"></i>
                                </div>
